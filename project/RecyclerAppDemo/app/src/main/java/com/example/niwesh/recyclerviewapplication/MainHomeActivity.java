...
public class MainHomeActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener{
    ...
    public void newActivity(View view){
        ...
        Intent intent = new Intent(MainHomeActivity.this, DialogActivity.class);
        startActivity(intent);
       /* PostUpdateDialog postUpdate = new PostUpdateDialog(MainHomeActivity.this);
        postUpdate.getWindow().setBackgroundDrawable(new ColorDrawable(Color.WHITE));
        postUpdate.setCancelable(true);
        postUpdate.show();*/
    }
